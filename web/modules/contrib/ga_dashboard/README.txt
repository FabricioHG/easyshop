DESCRIPTION
-----------
Google Analytics Dashboard module provides graphical reporting of your site's
tracking data. 

Google dashboard module have depends on Google Analytics Reports API module. Google Analytics Reports API module provide API for developers to access data
...
DEPENDENCIES
------------
* Google dashboard module have depends on Google Analytics Reports module and charts module.
...
* Google dashboard module have depends on Google Analytics Reports module


INSTALLATION
------------
1. Install Google Analytics Reports and charts module Via composer
2. Install Google Analytics Dashboard via composer
...
2. Enable Charts module and Google Charts or Highcharts sub-module to see
   graphical reports.
3. Go to "/admin/ga-dashboard" page to see
