...
class __TwigTemplate_b2cc586a4831e1a14b5651d98ffaba3a extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_ad96c2d8979d8d23860453e7c5eb1520->enter($__internal_ad96c2d8979d8d23860453e7c5eb1520_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "themes/contrib/belgrade/templates/views/views-mini-pager.html.twig"));
...
{% if items.previous or items.next %}
  <nav class=\"mt-4\" role=\"navigation\" aria-labelledby=\"{{ heading_id }}\">
    <h4 id=\"{{ heading_id }}\" class=\"visually-hidden\">{{ 'Pagination'|t }}</h4>
    <ul class=\"js-pager__items pagination justify-content-center\">
      {% if items.previous %}
        <li class=\"page-item\">
          <a href=\"{{ items.previous.href }}\" class=\"page-link\" title=\"{{ 'Go to previous page'|t }}\" rel=\"prev\"{{ items.previous.attributes|without('href', 'title', 'rel') }}>
      ...
      {% if items.next %}
        <li class=\"page-item\">
          <a href=\"{{ items.next.href }}\" class=\"page-link\" title=\"{{ 'Go to next page'|t }}\" rel=\"next\"{{ items.next.attributes|without('href', 'title', 'rel') }}>
...
{% endif %}
", "themes/contrib/belgrade/templates/views/views-mini-pager.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/webPlantillaWSYS/web/themes/contrib/belgrade/templates/views/views-mini-pager.html.twig");
    }
