...
<div class=\"cont_pag_prod\">
  <div class=\"cont_img_comprar\">
    <div class=\"int_img_cont\">
      <div class=\"sld-wrp\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["image_url"]) {
            // line 81
            echo "            ";
            if (twig_get_attribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, true, 81)) {
                // line 82
                echo "              ";
                if (($context["videos_urls"] ?? null)) {
                  ...
                  <iframe width=\"400\" height=\"400\" src=\"";
                    // line 84
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["videos_urls"] ?? null), 0, [], "any", false, false, true, 84), 84, $this->source), ["https://www.youtube.com/watch?v=" => "https://www.youtube.com/embed/"]), "html", null, true);
              ...
              ";
                    ...
                    // line 87
                    echo "                <div> <img src=\"";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["image_url"], "url", [], "any", false, false, true, 87), 87, $this->source), "html", null, true);
                    echo "\"> </div>
              ";
                }
                // line 89
                ...
                // line 90
                echo "              <div> <img src=\"";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["image_url"], "url", [], "any", false, false, true, 90), 90, $this->source), "html", null, true);
                echo "\"> </div>
            ";
            }
            // line 92
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["image_url_thum"]) {
            ...
            if (twig_get_attribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, true, 97)) {
                ...
                if (($context["videos_urls"] ?? null)) {
                    ...
                    // line 100
                    echo "                ";
                    $context["img_video_part_1"] = twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["videos_urls"] ?? null), 0, [], "any", false, false, true, 100), 100, $this->source), ["https://www.youtube.com/watch?v=" => "https://i.ytimg.com/vi_webp/"]);
                    // line 101
                    echo "                ";
                    $context["img_video"] = ($this->sandbox->ensureToStringAllowed(($context["img_video_part_1"] ?? null), 101, $this->source) . "/default.webp");
                    // line 102
                    echo "                <div> <img src=\"";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["img_video"] ?? null), 102, $this->source), "html", null, true);
                    echo "\"> </div>
              ...
              ";
                    ...
                    // line 105
                    echo "                <div> <img src=\"";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["image_url_thum"], "url_thum", [], "any", false, false, true, 105), 105, $this->source), "html", null, true);
                    echo "\"> </div>
              ";
                }
                // line 107
                ...
                // line 108
                echo "              <div> <img src=\"";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["image_url_thum"], "url_thum", [], "any", false, false, true, 108), 108, $this->source), "html", null, true);
                echo "\"> </div>
            ";
            }
            // line 110
    ...
    <div class=\"int_prod_carr\">
      <div class=\"text_ch\"><strong>Lorem ipsum dolor</strong> sit amet, consectetur sed <strong>do eiusmod</strong></div>
        ";
        // line 117
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "variations", [], "any", false, false, true, 117), 117, $this->source), "html", null, true);
        echo "    
    </div>
  ...
  <div class=\"cont_info\">
    <div class=\"int_titulo\">";
        // line 122
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "title", [], "any", false, false, true, 122), 122, $this->source), "html", null, true);
        echo "</div>
    <div class=\"int_precio\"> \$ ";
        // line 123
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ((twig_number_format_filter($this->env, $this->sandbox->ensureToStringAllowed(($context["precio"] ?? null), 123, $this->source), 2, ".", ",") . " ") . $this->sandbox->ensureToStringAllowed(($context["moneda"] ?? null), 123, $this->source)), "html", null, true);
        echo "</div>
    ";
        // line 124
        if (($context["precio_lista"] ?? null)) {
            ...
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ((twig_number_format_filter($this->env, $this->sandbox->ensureToStringAllowed(($context["precio_lista"] ?? null), 125, $this->source), 2, ".", ",") . " ") . $this->sandbox->ensureToStringAllowed(($context["moneda_precio_lista"] ?? null), 125, $this->source)), "html", null, true);
            echo " <span class=\"line_precio_lista\"></span> </div>
    ";
        }
        // line 127
        echo "    <div class=\"int_categoria\">";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "field_categoria", [], "any", false, false, true, 127), 127, $this->source), "html", null, true);
        echo "</div>
    <div class=\"int_cuerpo\">
      ";
        // line 129
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "body", [], "any", false, false, true, 129), 129, $this->source), "html", null, true);
        echo "
    </div>
...
";
    ...
    {
        return array (  344 => 168,  332 => 129,  326 => 127,  320 => 125,  318 => 124,  314 => 123,  310 => 122,  302 => 117,  294 => 111,  280 => 110,  274 => 108,  271 => 107,  265 => 105,  258 => 102,  255 => 101,  252 => 100,  250 => 99,  247 => 98,  244 => 97,  227 => 96,  223 => 94,  208 => 92,  202 => 90,  199 => 89,  193 => 87,  187 => 84,  184 => 83,  181 => 82,  178 => 81,  161 => 80,  153 => 74,  143 => 71,  140 => 70,  135 => 69,  133 => 68,  130 => 67,  128 => 66,  125 => 64,  123 => 63,  121 => 62,  119 => 61,  116 => 60,  114 => 59,  112 => 58,  110 => 57,  107 => 56,  100 => 54,  97 => 53,  94 => 52,  91 => 50,  89 => 48,  88 => 47,  87 => 46,  85 => 45,  82 => 43,  79 => 42,  76 => 41,  73 => 40,  70 => 39,  67 => 38,  62 => 37,  60 => 36,  57 => 35,  55 => 34,  52 => 32,  50 => 26,  45 => 23,  42 => 22,);
    }
...
", "themes/custom/ws_ecommerce/templates/commerce-product--full.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/webPlantillaWSYS/web/themes/custom/ws_ecommerce/templates/commerce-product--full.html.twig");
    ...
    public function checkSecurity()
    {
        ...
        static $filters = array("escape" => 23, "image_style" => 40, "merge" => 52, "replace" => 84, "number_format" => 123);
        static $functions = array("attach_library" => 23, "file_url" => 46);

        try {
            $this->sandbox->checkSecurity(
                ['set', 'if', 'for'],
                ['escape', 'image_style', 'merge', 'replace', 'number_format'],
