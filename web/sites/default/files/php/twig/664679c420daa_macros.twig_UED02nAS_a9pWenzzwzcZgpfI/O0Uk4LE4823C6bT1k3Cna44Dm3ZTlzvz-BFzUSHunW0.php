...
class __TwigTemplate_c129eac1f7468cd7b566125893a71eca extends Template
{
    private $source;
    private $macros = [];
...
";
  ...
  <svg class=\"beo beo-";
    ...
    ";
            // line 25
            echo "    <use xlink:href=\"";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ((array_key_exists("path", $context)) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed(($context["path"] ?? null), 25, $this->source), ((("/" . $this->extensions['Drupal\Core\Template\TwigExtension']->getActiveThemePath()) . "/images/belgrade-icons.svg#") . $this->sandbox->ensureToStringAllowed(($context["icon"] ?? null), 25, $this->source)))) : (((("/" . $this->extensions['Drupal\Core\Template\TwigExtension']->getActiveThemePath()) . "/images/belgrade-icons.svg#") . $this->sandbox->ensureToStringAllowed(($context["icon"] ?? null), 25, $this->source)))), "html", null, true);
            echo "\"/>
...
";
    ...
    {
        return array (  124 => 35,  118 => 33,  116 => 32,  113 => 31,  107 => 25,  102 => 20,  94 => 15,  90 => 14,  84 => 13,  81 => 12,  78 => 6,  76 => 5,  73 => 4,  51 => 3,  42 => 2,);
    }
...
{% endmacro %}
", "@belgrade/macros.twig", "/Applications/XAMPP/xamppfiles/htdocs/webPlantillaWSYS/web/themes/contrib/belgrade/templates/macros.twig");
    }
