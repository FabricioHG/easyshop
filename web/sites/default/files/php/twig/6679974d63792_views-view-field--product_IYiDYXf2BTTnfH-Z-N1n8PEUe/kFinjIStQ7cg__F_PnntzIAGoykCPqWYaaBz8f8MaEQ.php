...
class __TwigTemplate_54bef4a5a0b3fed74aabc0bd72140220 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 25
        if (twig_in_filter("Envío gratis", twig_get_attribute($this->env, $this->source, ($context["output"] ?? null), "__toString", [], "method", false, false, true, 25))) {
            // line 26
            echo "  <span class=\"envio_gratis_producto\">Envío gratis</span>
";
        }
    ...
    {
        return array (  48 => 26,  46 => 25,  42 => 23,);
    }
