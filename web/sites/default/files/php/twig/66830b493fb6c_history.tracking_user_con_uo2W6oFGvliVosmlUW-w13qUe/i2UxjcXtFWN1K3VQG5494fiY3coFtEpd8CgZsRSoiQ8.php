...
class __TwigTemplate_f1802ce84cd9792ae36f41348afddab3 extends Template
{
    private $source;
    private $macros = [];
...
<p>";
    ...
    {
        return array (  55 => 9,  51 => 8,  47 => 7,  42 => 6,);
    }
...
<p>{% trans %}You can display the new/updated status of content by creating or editing a view. There is a <em>Has new content</em> field for <em>Content</em> views, which displays the new/updated marker. There is also a <em>Has new content</em> filter, which limits the view to new and updated content.{% endtrans %}</p>", "@help_topics/history.tracking_user_content.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/easyshop.com.mx/web/core/modules/history/help_topics/history.tracking_user_content.html.twig");
    }
