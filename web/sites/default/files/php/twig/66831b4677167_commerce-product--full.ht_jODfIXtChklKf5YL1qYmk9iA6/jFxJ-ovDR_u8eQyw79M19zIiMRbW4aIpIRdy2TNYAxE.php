...
<div class=\"cont_pag_prod\">
  ...
  <div class=\"cont_info\">
    ...
    <div class=\"int_url_prod\">
      ";
        // line 148
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "field_proveedor_url", [], "any", false, false, true, 148), 148, $this->source), "html", null, true);
        echo "
    </div>
