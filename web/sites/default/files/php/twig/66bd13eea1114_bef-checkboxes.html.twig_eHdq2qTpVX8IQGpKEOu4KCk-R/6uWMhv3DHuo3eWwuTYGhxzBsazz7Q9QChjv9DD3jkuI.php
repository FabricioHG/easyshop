...
class __TwigTemplate_19fd9fed01a2b96b45fd8eaf2fffd721 extends Template
{
    private $source;
    private $macros = [];
...
($context["display_inline"] ?? null)) ? ("form--inline") : (""))];
        // line 21
        yield "<div";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["wrapper_attributes"] ?? null), "addClass", [($context["classes"] ?? null)], "method", false, false, true, 21), 21, $this->source), "html", null, true);
        yield ">
  ";
        // line 22
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
            ...
            if (($context["is_nested"] ?? null)) {
                ...
                // line 30
                yield "      ";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["item"] ?? null), 30, $this->source), "html", null, true);
                yield "
    ";
            }
            // line 32
...
";
    ...
    {
        return array (  112 => 33,  98 => 32,  92 => 30,  89 => 29,  86 => 28,  83 => 27,  80 => 26,  77 => 25,  74 => 24,  56 => 23,  54 => 22,  49 => 21,  47 => 19,  46 => 18,  45 => 17,  44 => 16,  43 => 13,);
    }
