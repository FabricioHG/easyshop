...
class __TwigTemplate_ae90256dcc02af9a7bfa3e03c1b0dae0 extends Template
{
    private $source;
    private $macros = [];
...
<p>{% trans %}<a href=\"https://www.php.net/manual/datetime.format.php#refsect1-datetime.format-parameters\">PHP date format codes reference</a>{% endtrans %}</p>", "@help_topics/system.config_basic.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/easyshop.com.mx/web/core/modules/system/help_topics/system.config_basic.html.twig");
    }
