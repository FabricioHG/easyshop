...
class __TwigTemplate_9dcf0a20ac18c02a9dd61e21b8af0933 extends Template
{
...
<div id=\"";
        // line 25
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["id"] ?? null), 25, $this->source), "html", null, true);
        yield "\" class=\"carousel ";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["effect"] ?? null), 25, $this->source), "html", null, true);
        yield "\" ";
        if (($context["ride"] ?? null)) {
            yield " data-bs-ride=\"";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["ride"] ?? null), 25, $this->source), "html", null, true);
            yield "\"
     data-bs-interval=\"";
            // line 26
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["interval"] ?? null), 26, $this->source), "html", null, true);
            yield "\"";
        }
        yield " data-bs-pause=\"";
     ...
     data-wrap=\"";
        // line 27
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["wrap"] ?? null), 27, $this->source), "html", null, true);
        yield "\">
      ...
      ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["row"]) {
                ...
                if ((($context["key"] % ($context["columns"] ?? null)) == 0)) {
                    ...
                    // line 35
                    yield "          <button class=\"";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Twig\Extension\CoreExtension::join($this->sandbox->ensureToStringAllowed(($context["indicator_classes"] ?? null), 35, $this->source), " "), "html", null, true);
                    yield "\" data-bs-target=\"#";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["id"] ?? null), 35, $this->source), "html", null, true);
                    ...
                    yield "\" aria-label=\"";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ((t("Slide") . " ") . $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, true, 35), 35, $this->source)), "html", null, true);
                    yield "\"></button>
        ";
                }
                // line 37
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
            ...
            if ((((CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, true, 47) - 1) % ($context["columns"] ?? null)) == 0)) {
                ...
                // line 49
                yield "        <div ";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["row"], "attributes", [], "any", false, false, true, 49), "addClass", [($context["row_classes"] ?? null)], "method", false, false, true, 49), 49, $this->source), "html", null, true);
                yield ">
          <div class=\"row\">
      ";
            }
            ...
            // line 53
            yield "      <div class=\"";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["breakpoints"] ?? null), 53, $this->source), "html", null, true);
        ...
        ";
            ...
            if ((($context["display"] ?? null) == "fields")) {
                // line 55
                yield "          ";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["row"], "image", [], "any", false, false, true, 55), 55, $this->source), "html", null, true);
                yield "
          ";
                // line 56
                if ((CoreExtension::getAttribute($this->env, $this->source, $context["row"], "title", [], "any", false, false, true, 56) || CoreExtension::getAttribute($this->env, $this->source, $context["row"], "description", [], "any", false, false, true, 56))) {
                    ...
                    if (($context["use_caption"] ?? null)) {
                        ...
                        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["caption_breakpoints"] ?? null), 58, $this->source), "html", null, true);
                        yield "\">
          ";
                    }
                    // line 60
                    ...
                    if (CoreExtension::getAttribute($this->env, $this->source, $context["row"], "title", [], "any", false, false, true, 60)) {
                        // line 61
                        yield "                <h3>";
                        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["row"], "title", [], "any", false, false, true, 61), 61, $this->source), "html", null, true);
                        yield "</h3>
              ";
                    }
                    // line 63
                    ...
                    if (CoreExtension::getAttribute($this->env, $this->source, $context["row"], "description", [], "any", false, false, true, 63)) {
                        // line 64
                        yield "                <p>";
                        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["row"], "description", [], "any", false, false, true, 64), 64, $this->source), "html", null, true);
                        yield "</p>
              ";
                    }
                    // line 66
  ...
  ";
        ...
        if (($context["navigation"] ?? null)) {
            ...
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["id"] ?? null), 86, $this->source), "html", null, true);
    ...
    <a class=\"carousel-control-next\" href=\"#";
            // line 90
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["id"] ?? null), 90, $this->source), "html", null, true);
