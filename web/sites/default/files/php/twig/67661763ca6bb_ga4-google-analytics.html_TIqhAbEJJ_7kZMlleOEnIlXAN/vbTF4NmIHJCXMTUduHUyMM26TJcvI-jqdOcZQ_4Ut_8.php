...
class __TwigTemplate_edade098fc10993d09a98f21cb913d47 extends Template
{
...
<script async ";
        // line 10
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(($context["script_attributes"] ?? null));
        yield " src=\"https://www.googletagmanager.com/gtag/js?id=";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["measurement_id"] ?? null), "html", null, true);
        yield "\"></script>
<script ";
        // line 11
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(($context["script_attributes"] ?? null));
